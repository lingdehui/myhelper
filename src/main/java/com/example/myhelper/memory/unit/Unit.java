 ...
 * @param scriptable          是否可脚本化执行
 * @param script              预编译线性脚本；scriptable=true 时执行此列表
...
public record Unit(
    ...
    public boolean isScriptable() {
        return scriptable && status == UnitStatus.ACTIVE && script != null && !script.isEmpty();
    }
