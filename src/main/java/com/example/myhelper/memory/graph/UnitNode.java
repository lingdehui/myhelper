 ...
 * 复杂字段（notes/params/outputSignature/script/failureCauses/explorationRecords）
...
public class UnitNode {
    ...
    public boolean isScriptable() { return scriptable; }
    public void setScriptable(boolean scriptable) { this.scriptable = scriptable; }
