...
public class NovelOutlineNode {
    ...
    /**
     * 本书专属的写作档案。存放题材、叙事视角、节奏、篇幅、禁忌表达和希望读者感受到的效果。
     * 这类偏好不能写死在系统提示词中，否则会污染其他作品。
     */
    private String writingProfile;
    ...
    public String getWritingProfile() { return writingProfile; }
    public void setWritingProfile(String writingProfile) { this.writingProfile = writingProfile; }
